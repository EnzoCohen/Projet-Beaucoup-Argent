                        ...
                        <div className="flex items-center justify-center w-full lg:p-12">
                            <div className="flex items-center xl:p-10 w-130">
                                <form className="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl" onSubmit={handleSubmit}>
                                    ...
                                    <input id="email" type="email" placeholder="mail@plannify.com" className="flex items-center w-full px-5 py-4 mr-2 text-sm font-medium outline-none focus:bg-grey-400 mb-7 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl" value={email} onChange={(e) => setEmail(e.target.value)} />
                                    ...
                                    <div className="flex flex-row justify-end mb-8">
                                        <a href="javascript:void(0)" className="text-sm font-medium text-purple-blue-500">Mot de passe oublié ?</a>
                                    </div>
                                    ...
                                    <div className="flex gap-3 flex-col ">
                                        ...
                                        <div className="m-3">
                                            <Link to={"/register"} className="font-bold text-grey-700"> Pas encore inscrit ?<br></br> Créer votre compte dès maintenant</Link>
                                        </div>
                                    </div>
                                </form>
                            </div>
